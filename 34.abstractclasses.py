...
class      MyClass(My_ABC_Class):
    ...
    def  get_val(self):
        ...
        print("I'm  part    of  the Absttract   Methods    defined    in    My_ABC_Class()")
        return    self.val
...
Calling    the     get_val()   method
I'm  part    of  the Absttract   Methods    defined    in    My_ABC_Class()
10

Calling    the     hello()     method
I'm  *not*   part    of    the   Abstract    Methods    defined  in    My_ABC_Classes()
